...
export default function HomePageClient({ scrapeAndAnalyze }: HomePageClientProps) {
  ...
  const [tool1ComparisonResultsCount, setTool1ComparisonResultsCount] = useState({
    common: 0,
    mySiteOnly: 0,
    competitorOnly: 0,
    totalUnique: 0,
  ...
  const [analyzedPages, setAnalyzedPages] = useState<LandingPageWithAnalysis[]>([]);
          ...
          {activeTool === 'tool5' && (
            <div id="tool5-container">
              <Tool5MasterReport
                ...
                tool2Data={{
                  analysisResults: tool2AnalysisResults,
                  industryContext: `Industry: ${tool2Industry}, Keywords: ${tool2IndustryKeywords}`
                }}
                toolDataForSeoData={{
                  seedKeywords: dataForSeoSeedKeywords,
                  locationContext: `Location: ${dataForSeoLocationCode}, Language: ${dataForSeoLanguageCode}`,
